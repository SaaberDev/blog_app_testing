    ...
    <main class="">
        <section class="max-w-2xl mx-auto my-16">
            <h2 class="max-w-2xl mx-auto flex items-center text-sm uppercase tracking-wider font-medium">
                ...
                <span>Written by <a class="font-semibold hover:underline" href="">Brent Roose</a></span>
            </h2>
            ...
            <aside class="max-w-4xl mx-auto mt-12 bg-opacity-5 bg-ink px-8 py-12">
                <div class="max-w-2xl mx-auto">   
                    <p class="text-xl font-display">
                        ...
                        <br>Leave us a link to an interesting blogpost.
                    </p>
                    ...
                    <form action="{{ action(\App\Http\Controllers\ExternalPostSuggestionController::class) }}" method="post" class="mt-8 grid grid-cols-[auto,1fr] items-center gap-4">
                        ...
                        <input type="text" name="title" class="bg-paper border-0 focus:bg-white focus:ring-ink">

                        <label for="url" class=" text-sm uppercase tracking-wider font-medium">URL</label>
                        <input type="text" name="url" class="bg-paper border-0 focus:bg-white focus:ring-ink">

                        <div class="col-start-2">
                            <button type="submit" class="bg-ink text-paper px-4 py-2 font-medium focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-ink">Suggest!</button>
                        </div>
                    </form>
                </div>
            </aside>
